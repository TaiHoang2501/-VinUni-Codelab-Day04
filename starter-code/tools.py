    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                "customer_name": {
                    "type": "string",
                    "description": "Tên của khách hàng cần hỗ trợ."
                },
                "issue_description": {
                    "type": "string",
                    "description": "Mô tả chi tiết về vấn đề hoặc yêu cầu cần hỗ trợ."
                },
                "priority": {
                    "type": "string",
                    "enum": ["low", "medium", "high"],
                    "description": "Mức độ ưu tiên của ticket. Mặc định là 'medium'."
                }
            },
